package org.annakhuseinova.completablefuture9.externalservice;
...
public class Client {
    ...
    private static String PRODUCT_REQUEST_FORMAT = "http://localhost:7070/sec01/product/%d";
    private static String RATING_REQUEST_FORMAT = "http://localhost:7070/sec01/rating/%d";
    ...
    private static String callExternalService(String url){
        ...
        try(var stream = URI.create(url).toURL().openStream()){ // input stream must be closed
